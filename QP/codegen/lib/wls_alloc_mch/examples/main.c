...
static void main_wls_alloc_mch(void);
...
static void main_wls_alloc_mch(void)
{
  ...
  /* Initialize function 'wls_alloc_mch' input arguments. */
  /* Initialize function input argument 'v'. */
  /* Initialize function input argument 'u'. */
  /* Call the entry-point 'wls_alloc_mch'. */
  argInit_3x1_real_T(dv0);
  argInit_4x1_real_T(u);
  wls_alloc_mch(dv0, u, argInit_real_T(), argInit_boolean_T());
}
